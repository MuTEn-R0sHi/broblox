...
describe("EventService (obby)", () => {
  ...
  describe("onEventStart", () => {
    ...
    it("fires EventStarted with undefined modifiers when event has none", async () => {
      await loadModule();
  ...
  describe("onEventEnd", () => {
    ...
    it("fires EventEnded with undefined modifiers when event has none", async () => {
      await loadModule();
