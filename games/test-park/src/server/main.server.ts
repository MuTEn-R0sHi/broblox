...
import { StaffGateService } from "./services/StaffGateService";
import { TestParkService } from "./services/TestParkService";
...
app
  ...
  .register(StaffGateService)
  .register(TestParkService);
