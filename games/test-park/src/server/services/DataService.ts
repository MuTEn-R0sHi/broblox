...
import { TestParkPlayerData } from "shared/types";
...
const DEFAULT_PLAYER_DATA: TestParkPlayerData = {
...
const dataHandle = createDataService<TestParkPlayerData>({
  storeConfig: {
    name: "test_park_player_data",
...
export const DataService: Service & {
  getData(player: Player): TestParkPlayerData | undefined;
  updateData(player: Player, updates: Partial<TestParkPlayerData>): void;
