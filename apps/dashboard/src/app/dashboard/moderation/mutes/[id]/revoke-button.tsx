...
import { revokeMute } from "./actions";

interface RevokeMuteButtonProps {
  muteId: string;
  playerId: bigint;
}

export function RevokeMuteButton({ muteId, playerId }: RevokeMuteButtonProps) {
  ...
  async function handleRevoke() {
    if (!reason.trim()) {
      setError("Please provide a reason for revoking the mute");
      return;
    }
    ...
    try {
      ...
      setError("Failed to revoke mute");
    } finally {
      setLoading(false);
    }
  }
    ...
    <div className="space-y-4">
      ...
      <div className="space-y-2">
        ...
        <textarea
          ...
          placeholder="Why is this mute being revoked?"
